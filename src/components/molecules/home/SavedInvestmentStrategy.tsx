...
export interface SavedInvestmentStrategyProps {
  onSelectStrategyRecommended: (data: any) => void;
}

export default function SavedInvestmentStrategy(
  props: SavedInvestmentStrategyProps
) {
  const strategies = [
    "7 Magnificent Stock",
    "Aggresive",
  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <CardTitle className="text-lg font-bold">Strategi Kamu</CardTitle>
      </CardHeader>
      <CardContent>
